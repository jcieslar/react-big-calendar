!(function(e, t) {
      ...
      if ('object' == typeof e)
        if (e.push)
          for (t = 0; t < e.length; t++)
            e[t] && (n = S(e[t])) && (r && (r += ' '), (r += n))
        else for (t in e) e[t] && (n = S(t)) && (r && (r += ' '), (r += n))
      else 'boolean' == typeof e || e.call || (r && (r += ' '), (r += e))
    return r
  }
  function D() {
    for (var e, t = 0, n = ''; t < arguments.length; )
      (e = S(arguments[t++])) && (n && (n += ' '), (n += e))
    return n
  }
  var x = { PREVIOUS: 'PREV', NEXT: 'NEXT', TODAY: 'TODAY', DATE: 'DATE' },
    T = {
      MONTH: 'month',
      WEEK: 'week',
      WORK_WEEK: 'work_week',
    ...
    j = Object.keys(T).map(function(e) {
      return T[e]
    })
  b.oneOfType([b.string, b.func]),
    b.any,
    b.func,
    b.oneOfType([
      b.arrayOf(b.oneOf(j)),
      b.objectOf(function(e, t) {
        if (-1 !== j.indexOf(t) && 'boolean' == typeof e[t]) return null
        for (
          ...
          r[o - 2] = arguments[o]
        return b.elementType.apply(b, [e, t].concat(r))
      }),
    ]),
    b.oneOfType([b.oneOf(['overlap', 'no-overlap']), b.func])
  function N(e, t) {
    e && e.apply(null, [].concat(t))
  }
  var C = b.oneOfType([b.string, b.func])
  var k = function(e) {
    var t = this
    'function' != typeof e.format && E(!1),
      'function' != typeof e.firstOfWeek && E(!1),
      (this.propType = e.propType || C),
      ...
      (this.format = function() {
        ...
        return function(e, t, n, r, o) {
          ...
          return null != i && 'string' != typeof i && E(!1), i
  ...
  function $(e, t, n) {
    switch (((e = new Date(e)), n)) {
      ...
      case Y:
        return fe(e, fe(e) + 10 * t)
      case B:
        return fe(e, fe(e) + 100 * t)
    }
  ...
  function G(e, t, n) {
    ...
    return (
      t === Y && (e = X(e, fe(e) % 10, 'year')),
      t === B && (e = X(e, fe(e) % 100, 'year')),
      t === H &&
        (e = (function(e, t, n) {
          var r = (ce(e) + 7 - (n || 0)) % 7
          return void 0 === t ? r : $(e, t - r, W)
        })(e, 0, n)),
      e
    )
  }
  function q(e, t, n) {
    return (e = X((e = $((e = G((e = new Date(e)), t, n)), 1, t)), 1, P))
  }
  var K = pe(function(e, t) {
      return e === t
    }),
    Z = pe(function(e, t) {
      return e > t
  ...
  function re(e, t, n, r) {
    return (r = r || 'day'), (!t || J(e, t, r)) && (!n || ee(e, n, r))
  }
  var oe = de('Milliseconds'),
    ie = de('Seconds'),
    ae = de('Minutes'),
    se = de('Hours'),
    ce = de('Day'),
  ...
  function me(e, t) {
    var n = G(e, 'month')
    return G(n, 'week', t.startOfWeek())
  }
  function ve(e, t) {
    var n = q(e, 'month')
    return q(n, 'week', t.startOfWeek())
  }
  function ge(e, t) {
    var n = G(e, t)
    return K(n, e) ? n : $(n, 1, t)
  }
  function ye(e, t, n) {
    void 0 === n && (n = 'day')
    for (var r = e, o = []; ee(r, t, n); ) o.push(r), (r = $(r, 1, n))
    return o
  }
  function be(e, t) {
  ...
  function we(e) {
    return 0 === se(e) && 0 === ae(e) && 0 === ie(e) && 0 === oe(e)
  }
  function Ee(e, t, n) {
    return n && 'milliseconds' !== n
      ? Math.round(Math.abs(+G(e, n) / he[n] - +G(t, n) / he[n]))
      : Math.abs(+e - +t)
  }
  function _e(e, t, n) {
    var r = -1,
  ...
  var Me =
    ...
    De = Me || Se || Function('return this')(),
    xe = De.Symbol,
    Te = Object.prototype,
    je = Te.hasOwnProperty,
    Ne = Te.toString,
    Ce = xe ? xe.toStringTag : void 0
  ...
  function Be(e) {
    return null != e && Ye(e.length) && !Ue(e)
  }
  ...
  function qe(e, t, n) {
    ...
    var r = typeof t
    return (
      !!('number' == r ? Be(n) && Ge(t, n.length) : 'string' == r && t in n) &&
      Oe(n[t], e)
    )
  }
  function Ke(e) {
  ...
  function Je(e) {
    return 'symbol' == typeof e || (Ke(e) && Pe(e) == Ze)
  }
  var Qe = NaN,
    et = /^\s+|\s+$/g,
    tt = /^[-+]0x[0-9a-f]+$/i,
  ...
  function vt(e) {
    return (function(e) {
      return e.replace(ht, '-$1').toLowerCase()
    })(e).replace(mt, '-ms-')
  }
  ...
  function yt(e, t) {
    var n = '',
      r = ''
    if ('string' == typeof t)
      return e.style.getPropertyValue(vt(t)) || pt(e).getPropertyValue(vt(t))
  ...
  function Mt(e) {
    ...
    return r && bt(r, e)
      ? (void 0 !== e.getBoundingClientRect && (n = e.getBoundingClientRect()),
        (n = {
          top: n.top + Ot(e) - (r.clientTop || 0),
          left: n.left + _t(e) - (r.clientLeft || 0),
          width: n.width,
          height: n.height,
        }))
      : n
  ...
  function xt(e, t) {
    ...
    if ('fixed' === yt(e, 'position')) n = e.getBoundingClientRect()
      ...
      var o =
        ...
        (function(e) {
          for (
            var t = dt(e), n = e && e.offsetParent;
            St(n) && 'HTML' !== n.nodeName && 'static' === yt(n, 'position');

          )
            n = n.offsetParent
          return n || t.documentElement
        })(e)
      ;(n = Mt(e)), 'html' !== Dt(o) && (r = Mt(o))
      var i = String(yt(o, 'borderTopWidth') || 0)
      r.top += parseInt(i, 10) - Ot(o) || 0
      var a = String(yt(o, 'borderLeftWidth') || 0)
      r.left += parseInt(a, 10) - _t(o) || 0
    }
    var s = String(yt(e, 'marginTop') || 0),
      c = String(yt(e, 'marginLeft') || 0)
    return ft({}, n, {
  ...
  var Rt = function(e) {
      'function' == typeof window[Nt] && window[Nt](e)
    },
    At = Ct,
    Ft = (function(e) {
      function t() {
      ...
      return (
        ...
        (t.prototype.render = function() {
          var e = this.props,
            ...
            x = h.start(o),
            T = h.allDay(o),
            j = c || T || Ee(x, ge(S, 'day'), 'day') > 1,
            N = m.eventProp(o, x, S, i),
            C = r.createElement(
              'div',
              { className: 'rbc-event-content', title: M || void 0 },
              y
                ? r.createElement(y, {
                    event: o,
                    continuesPrior: d,
          ...
          return r.createElement(
            b,
            a({}, this.props, { type: 'date' }),
            r.createElement(
              'div',
              a({}, _, {
                tabIndex: 0,
                style: a({}, N.style, t, o.style),
                className: D('rbc-event', n, N.className, {
                  'rbc-selected': i,
                  'rbc-event-allday': j,
    ...
    return (
      (n.componentDidMount = function() {
        var e,
          ...
          r = n.popupOffset,
          o = void 0 === r ? 5 : r,
          i = Mt(n.popperRef.current),
          a = i.top,
          s = i.left,
          c = i.width,
          l = i.height,
          u = window.innerHeight + Ot(window),
          f = window.innerWidth + _t(window),
          d = a + l,
          p = s + c
        ;(d > u || p > f) &&
          (d > u && (e = d - u + (o.y || +o || 0)),
        ...
        return r.createElement(
          ...
          t.map(function(e, t) {
            return r.createElement(Ft, {
              ...
              components: s,
              onDoubleClick: l,
              continuesPrior: Q(i.end(e), u, 'day'),
              continuesAfter: J(i.start(e), f, 'day'),
              slotStart: u,
              slotEnd: f,
              selected: Pt(e, n),
            })
  ...
  var Wt = r.forwardRef(function(e, t) {
    return r.createElement(zt, a({ popperRef: t }, e))
  })
  function Ht() {
    return (Ht =
      Object.assign ||
  ...
  for (
    var Ut = 'undefined' != typeof window && 'undefined' != typeof document,
    ...
    if (Ut && navigator.userAgent.indexOf(Vt[Bt]) >= 0) {
      Yt = 1
      break
    }
  var $t =
  ...
  function Kt(e) {
    ...
    var t = Gt(e),
      ...
      r = t.overflowX,
      o = t.overflowY
    return /(auto|scroll|overlay)/.test(n + o + r) ? e : Kt(qt(e))
  }
  var Zt = Ut && !(!window.MSInputMethodContext || !document.documentMode),
    Jt = Ut && /MSIE 10/.test(navigator.userAgent)
  function Qt(e) {
    return 11 === e ? Zt : 10 === e ? Jt : Zt || Jt
  }
  function en(e) {
    if (!e) return document.documentElement
    for (
      var t = Qt(10) ? document.body : null, n = e.offsetParent || null;
  ...
  function tn(e) {
    return null !== e.parentNode ? tn(e.parentNode) : e
  }
  function nn(e, t) {
    ...
    if ((e !== c && t !== c) || r.contains(o))
      return 'BODY' === (s = (a = c).nodeName) ||
        ('HTML' !== s && en(a.firstElementChild) !== a)
        ? en(c)
        : c
    var l = tn(e)
    return l.host ? nn(l.host, t) : nn(e, tn(t).host)
  }
  function rn(e) {
    var t =
        'top' ===
  ...
  function sn(e) {
    ...
    return { height: an('Height', t, n, r), width: an('Width', t, n, r) }
  }
  var cn = function(e, t) {
      if (!(e instanceof t))
  ...
  function dn(e) {
    return fn({}, e, { right: e.left + e.width, bottom: e.top + e.height })
  }
  function pn(e) {
    var t = {}
    try {
    ...
    var o = {
      ...
      i = 'HTML' === e.nodeName ? sn(e.ownerDocument) : {},
    ...
    if (c || l) {
      var u = Gt(e)
      ;(c -= on(u, 'x')), (l -= on(u, 'y')), (o.width -= c), (o.height -= l)
    }
    return dn(o)
  }
  function hn(e, t) {
  ...
  function mn(e) {
    if (!e || !e.parentElement || Qt()) return document.documentElement
    for (var t = e.parentElement; t && 'none' === Gt(t, 'transform'); )
      t = t.parentElement
    ...
    if ('viewport' === r)
      ...
      if (
        ...
        (function e(t) {
          ...
          if ('fixed' === Gt(t, 'position')) return !0
          var r = qt(t)
          return !!r && e(r)
        })(a)
      )
  ...
  function On(e, t, n) {
    return (
      (void 0 === n
        ...
        e.enabled &&
          Xt(n) &&
          ((t.offsets.popper = dn(t.offsets.popper)),
          (t.offsets.reference = dn(t.offsets.reference)),
          (t = n(t, e)))
      }),
      t
    )
  ...
  function xn(e, t, n, r) {
    ;(n.updateBound = r),
      Dn(e).addEventListener('resize', n.updateBound, { passive: !0 })
    var o = Kt(e)
    return (
      (function e(t, n, r, o) {
  ...
  function Tn() {
    ...
    this.state.eventsEnabled &&
      ...
      (t = this.state),
      Dn(e).removeEventListener('resize', t.updateBound),
  ...
  var Cn = Ut && /Firefox/i.test(navigator.userAgent)
  function kn(e, t, n) {
    var r = _n(e, function(e) {
        return e.name === t
      }),
  ...
  function Fn(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
      n = An.indexOf(e),
      r = An.slice(n + 1).concat(An.slice(0, n))
  ...
  var In = {
      ...
      modifiers: {
          ...
          fn: function(e) {
            ...
            if (r) {
              var o = e.offsets,
                ...
                u = {
                  start: un({}, c, i[c]),
                  end: un({}, c, i[c] + i[l] - a[l]),
                }
              e.offsets.popper = fn({}, a, u[r])
            }
            return e
          },
        },
        ...
        preventOverflow: {
          ...
          enabled: !0,
          fn: function(e, t) {
            var n = t.boundariesElement || en(e.instance.popper)
            e.instance.reference === n && (n = en(n))
            var r = Sn('transform'),
        ...
        arrow: {
          ...
          fn: function(e, t) {
            var n
            if (!kn(e.instance.modifiers, 'arrow', 'keepTogether')) return e
            var r = t.element
            if ('string' == typeof r) {
            ...
            s[p] - h < a[f] && (e.offsets.popper[f] -= a[f] - (s[p] - h)),
              ...
              (e.offsets.popper = dn(e.offsets.popper))
            var m = s[f] + s[l] / 2 - h / 2,
              v = Gt(e.instance.popper),
              g = parseFloat(v['margin' + u], 10),
              y = parseFloat(v['border' + u + 'Width'], 10),
              b = m - e.offsets.popper[f] - g - y
            return (
              (b = Math.max(Math.min(a[l] - h, b), 0)),
              (e.arrowElement = r),
              (e.offsets.arrow = (un((n = {}), f, Math.round(b)),
              un(n, d, ''),
              n)),
              e
            )
        ...
        flip: {
          ...
          enabled: !0,
          fn: function(e, t) {
            if (Mn(e.instance.modifiers, 'inner')) return e
              ...
              a.forEach(function(s, c) {
                ...
                ;(d || g || E) &&
                  ...
                  (e.offsets.popper = fn(
                    {},
                    e.offsets.popper,
                    En(e.instance.popper, e.offsets.reference, e.placement)
                  )),
                  (e = On(e.instance.modifiers, e, 'flip')))
              }),
              e
            )
          },
        ...
        hide: {
          ...
          enabled: !0,
          fn: function(e) {
            if (!kn(e.instance.modifiers, 'hide', 'preventOverflow')) return e
            var t = e.offsets.reference,
              n = _n(e.instance.modifiers, function(e) {
        ...
        computeStyle: {
          ...
          fn: function(e, t) {
            var n = t.x,
              r = t.y,
              o = e.offsets.popper,
              i = _n(e.instance.modifiers, function(e) {
            ...
            var a = void 0 !== i ? i : t.gpuAcceleration,
              ...
              u = (function(e, t) {
                var n = e.offsets,
                  ...
                  d = t ? (u || f || c % 2 == l % 2 ? i : a) : s,
                  p = t ? i : s
                return {
                  left: d(
                    c % 2 == 1 && l % 2 == 1 && !f && t ? r.left - 1 : r.left
                  ),
                  top: p(r.top),
                  bottom: p(r.bottom),
                  right: d(r.right),
                }
              })(e, window.devicePixelRatio < 2 || !Cn),
            ...
            return (
              (e.attributes = fn({}, y, e.attributes)),
              (e.styles = fn({}, l, e.styles)),
              (e.arrowStyles = fn({}, e.offsets.arrow, e.arrowStyles)),
              e
            )
          },
          gpuAcceleration: !0,
          ...
          fn: function(e) {
            ...
            return (
              ...
              e.arrowElement &&
                ...
                Nn(e.arrowElement, e.arrowStyles),
              e
            )
          },
          onLoad: function(e, t, n, r, o) {
            var i = yn(o, t, e, n.positionFixed),
              a = gn(
                n.placement,
                i,
                t,
            ...
            return (
              ...
              Nn(t, { position: n.positionFixed ? 'fixed' : 'absolute' }),
              n
            )
          },
    ...
    zn = (function() {
      function e(t, n) {
        ...
        cn(this, e),
          ...
          (this.options = fn({}, e.Defaults, o)),
          (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
          (this.reference = t && t.jquery ? t[0] : t),
          (this.popper = n && n.jquery ? n[0] : n),
          (this.options.modifiers = {}),
          Object.keys(fn({}, e.Defaults.modifiers, o.modifiers)).forEach(
            function(t) {
              r.options.modifiers[t] = fn(
                {},
          ...
          (this.modifiers = Object.keys(this.options.modifiers)
            .map(function(e) {
              return fn({ name: e }, r.options.modifiers[e])
            })
            .sort(function(e, t) {
  ...
  ;(zn.Utils = ('undefined' != typeof window ? window : global).PopperUtils),
    (zn.placements = Rn),
    (zn.Defaults = In)
  var Hn = function(e) {
  ...
  var or = r.forwardRef(function(e, n) {
    var i = e.flip,
      a = e.placement,
      ...
      S = (function(e, n, r) {
        ...
        return (
          ...
          t.useEffect(
            function() {
              if (a && null !== e && null !== n) {
                var t = h.arrow && Ht({}, h.arrow, { element: h.arrow.element })
                return (
                  (m.current = new zn(e, n, {
                    placement: c,
                    positionFixed: u,
                    modifiers: Ht({}, h, {
                      arrow: t,
        ...
        Ht({}, l, {
          ...
          enableEvents: e.show,
          modifiers: Ht({}, M, {
            preventOverflow: Ht({ padding: s || 5 }, M.preventOverflow),
            arrow: Ht({}, M.arrow, { enabled: !!m, element: m }),
            flip: Ht({ enabled: !!i }, M.preventOverflow),
          }),
        })
      ),
      D = S.styles,
    ...
    if (
      ...
      t.useEffect(
        function() {
          if (!R && null != j) {
            var e = Kn(document, F, I, !0),
              t = Kn(document, F, z),
              n = Kn(document, 'keyup', W),
              r = []
            return (
              'ontouchstart' in document.documentElement &&
                (r = [].slice.call(document.body.children).map(function(e) {
                  return Kn(e, 'mousemove', er)
                })),
              function() {
                e(),
                  t(),
    ...
    return y ? o.createPortal(U, y) : null
  })
  function ir(e, t) {
    var n = wt(e)
    return n ? n.innerHeight : t ? e.clientHeight : Mt(e).height
  }
  ;(or.displayName = 'Overlay'),
    (or.propTypes = {
      show: b.bool,
      placement: b.oneOf(zn.placements),
      target: b.any,
      container: b.any,
      flip: b.bool,
      children: b.func.isRequired,
      containerPadding: b.number,
      popperConfig: b.object,
      rootClose: b.bool,
      rootCloseEvent: b.oneOf(['click', 'mousedown']),
      rootCloseDisabled: b.bool,
      onHide: function(e) {
        var t = b.func
    ...
    (or.defaultProps = { containerPadding: 5 })
  var ar,
    sr = Function.prototype.bind.call(Function.prototype.call, [].slice)
  function cr(e, t) {
    if (!ar) {
      var n = document.body,
        r =
  ...
  try {
    ...
    Tt &&
      ...
      window.removeEventListener('test', fr, !0))
  } catch (e) {}
  function dr(e, t, n, r) {
    return (
      (function(e, t, n, r) {
  ...
  function pr(e, t, n) {
    return void 0 === n && (n = document), dr(n, e, t, { passive: !1 })
  }
  function hr(e, t) {
    var n = t.clientX,
      r = t.clientY
  ...
  var gr = (function() {
    function e(e, t) {
      ...
      ;(this.isDetached = !1),
        ...
        (this._removeTouchMoveWindowListener = pr(
          'touchmove',
          function() {},
          window
        )),
        (this._removeKeyDownListener = pr('keydown', this._keyListener)),
        (this._removeKeyUpListener = pr('keyup', this._keyListener)),
        (this._removeDropFromOutsideListener = pr(
          'drop',
          this._dropFromOutsideListener
        )),
        (this._onDragOverfromOutisde = pr(
          'dragover',
    ...
    return (
      ...
      (t.isSelected = function(e) {
        ...
        return !(!t || !this.selecting) && yr(t, br(e))
      }),
      (t.filter = function(e) {
        ...
        var n = this,
          ...
          a = function(t) {
            ;(r = setTimeout(function() {
              ...
              (o = pr('touchmove', function() {
                return c()
              })),
              (i = pr('touchend', function() {
                return c()
              }))
          },
          s = pr('touchstart', a),
      ...
      (t._addInitialEventListener = function() {
        var e = this,
          t = pr('mousedown', function(t) {
            e._removeInitialEventListener(),
              e._handleInitialEvent(t),
              (e._removeInitialEventListener = pr(
                'mousedown',
                e._handleInitialEvent
              ))
          }),
          n = pr('touchstart', function(t) {
            e._removeInitialEventListener(),
      ...
      (t._dropFromOutsideListener = function(e) {
        var t = vr(e),
          ...
          o = t.clientX,
          i = t.clientY
        this.emit('dropFromOutside', { x: n, y: r, clientX: o, clientY: i }),
          e.preventDefault()
      }),
      ...
      (t._handleInitialEvent = function(e) {
        if (!this.isDetached) {
          ...
          if (
            ...
            ((l = r),
            (u = o),
            !(c = s) || bt(c, document.elementFromPoint(l, u)))
          ) {
            var c, l, u
            if (!this.globalMouse && s && !bt(s, e.target)) {
              var f = (function(e) {
                  void 0 === e && (e = 0)
                  'object' != typeof e &&
            ...
            if (
              ...
              switch (e.type) {
                case 'mousedown':
                  ;(this._removeEndListener = pr(
                    'mouseup',
                    this._handleTerminatingEvent
                  )),
                    (this._onEscListener = pr(
                      'keydown',
                      this._handleTerminatingEvent
                    )),
                    (this._removeMoveListener = pr(
                      'mousemove',
      ...
      (t._handleTerminatingEvent = function(e) {
        ...
        if (
          ...
          var o = !this.container || bt(this.container(), e.target),
            i = this._selectRect,
            a = this.isClick(n, r)
          return (
      ...
      (t._handleClickEvent = function(e) {
        var t = vr(e),
          ...
          i = t.clientY,
          a = new Date().getTime()
        return this._lastClickData && a - this._lastClickData.timestamp < 250
          ? ((this._lastClickData = null),
            this.emit('doubleClick', { x: n, y: r, clientX: o, clientY: i }))
      ...
      (o._selectable = function() {
        ...
        r.on('selecting', function(n) {
            ...
            var l = br(t),
              u = (function(e, t, n, r, o) {
                var i = -1,
                  ...
                  p = t.top > e.y
                return (
                  n.top < t.top && n.bottom > t.bottom && ((i = 0), (a = s)),
                  u && (p ? ((i = 0), (a = l)) : d && ((i = l), (a = s))),
                  f &&
                    ((i = a = o
          ...
          r.on('select', function(t) {
            e._selectSlot(a({}, e.state, { action: 'select', bounds: t })),
              (e._initial = {}),
  ...
  ;(Sr.propTypes = {}), (Sr.defaultProps = a({}, _r))
  ...
  ;(Tr.prototype.clear = function() {
    ...
    (Tr.prototype.delete = function(e) {
      ...
      return !(
        n < 0 ||
        (n == t.length - 1 ? t.pop() : xr.call(t, n, 1), --this.size, 0)
      )
    }),
  ...
  var jr,
    ...
    Cr = (jr = /[^.]+$/.exec((Nr && Nr.keys && Nr.keys.IE_PROTO) || ''))
      ? 'Symbol(src)_1.' + jr
      : ''
  ...
  function Wr(e) {
    return (
      !(!Le(e) || ((t = e), Cr && Cr in t)) && (Ue(e) ? zr : Ar).test(Rr(e))
    )
    var t
  }
  function Hr(e, t) {
  ...
  ;(Gr.prototype.clear = function() {
    ...
    (Gr.prototype.has = function(e) {
      var t = this.__data__
      return Vr ? void 0 !== t[e] : $r.call(t, e)
    }),
    (Gr.prototype.set = function(e, t) {
      var n = this.__data__
      return (
        (this.size += this.has(e) ? 0 : 1),
        (n[e] = Vr && void 0 === t ? Xr : t),
        this
      )
    }),
  ...
  ;(eo.prototype.add = eo.prototype.push = function(e) {
  ...
  function oo(e, t, n, r, o, i) {
    ...
    var u = -1,
      f = !0,
      d = n & ro ? new eo() : void 0
    for (i.set(e, t), i.set(t, e); ++u < s; ) {
      var p = e[u],
        h = t[u]
      if (r) var m = a ? r(h, p, u, t, e, i) : r(p, h, u, e, t, i)
      if (void 0 !== m) {
        if (m) continue
        f = !1
        break
      ...
      if (d) {
        if (
          !to(t, function(e, t) {
            if (((a = t), !d.has(a) && (p === e || o(p, e, n, r, i))))
              return d.push(t)
            var a
          })
        ) {
  ...
  var co = 1,
    ...
    Eo = '[object DataView]',
    _o = xe ? xe.prototype : void 0,
    Oo = _o ? _o.valueOf : void 0
  function Mo(e, t) {
  ...
  var Ro = Object.prototype,
    ...
    Po = ko(
      ...
      ? ko
      : function(e) {
          return Ke(e) && Ao.call(e, 'callee') && !Fo.call(e, 'callee')
        }
  var Lo = 'object' == typeof e && e && !e.nodeType && e,
    Io =
      Lo && 'object' == typeof module && module && !module.nodeType && module,
    zo = Io && Io.exports === Lo ? De.Buffer : void 0,
    Wo =
      (zo ? zo.isBuffer : void 0) ||
      function() {
        return !1
      },
    Ho = {}
  ...
  ;(Ho['[object Float32Array]'] = Ho['[object Float64Array]'] = Ho[
    '[object Int8Array]'
  ] = Ho['[object Int16Array]'] = Ho['[object Int32Array]'] = Ho[
    '[object Uint8Array]'
  ] = Ho['[object Uint8ClampedArray]'] = Ho['[object Uint16Array]'] = Ho[
    '[object Uint32Array]'
  ] = !0),
    (Ho['[object Arguments]'] = Ho['[object Array]'] = Ho[
      '[object ArrayBuffer]'
    ] = Ho['[object Boolean]'] = Ho['[object DataView]'] = Ho[
      '[object Date]'
    ] = Ho['[object Error]'] = Ho['[object Function]'] = Ho[
      '[object Map]'
    ] = Ho['[object Number]'] = Ho['[object Object]'] = Ho[
      '[object RegExp]'
    ] = Ho['[object Set]'] = Ho['[object String]'] = Ho[
      '[object WeakMap]'
    ] = !1)
  var Vo = 'object' == typeof e && e && !e.nodeType && e,
    Yo =
      Vo && 'object' == typeof module && module && !module.nodeType && module,
    Bo = Yo && Yo.exports === Vo && Me.process,
    $o = (function() {
      try {
    ...
    Go = Xo
      ? Uo(Xo)
      : function(e) {
          return Ke(e) && Ye(e.length) && !!Ho[Pe(e)]
        },
  ...
  function Jo(e) {
    ...
    return e === (('function' == typeof t && t.prototype) || Zo)
  }
  function Qo(e, t) {
    return function(n) {
      return e(t(n))
    ...
    return Be(e)
      ...
      : (function(e) {
          ...
          for (var n in Object(e))
            ti.call(e, n) && 'constructor' != n && t.push(n)
          return t
        })(e)
  }
  function ri(e) {
  ...
  var ai = Hr(De, 'DataView'),
    ...
    hi = Rr(li),
    mi = Pe
  ;((ai && '[object DataView]' != mi(new ai(new ArrayBuffer(1)))) ||
    (Ur && '[object Map]' != mi(new Ur())) ||
    (si && '[object Promise]' != mi(si.resolve())) ||
    (ci && '[object Set]' != mi(new ci())) ||
    (li && '[object WeakMap]' != mi(new li()))) &&
    (mi = function(e) {
      var t = Pe(e),
  ...
  function _i(e, t, n, r, o, i) {
        ...
        a || Go(e)
          ...
          : (function(e, t, n, r, o, i, a) {
              switch (n) {
                ...
                case wo:
                  return !(
                    e.byteLength != t.byteLength || !i(new io(e), new io(t))
                  )
                case uo:
                case fo:
                case mo:
                ...
                case go:
                  var c = r & co
                  if ((s || (s = so), e.size != t.size && !c)) return !1
                  var l = a.get(e)
                  if (l) return l == t
                  ;(r |= lo), a.set(e, t)
                  var u = oo(s(e), s(t), r, o, i, a)
                  return a.delete(e), u
                case bo:
    ...
    if (!(n & gi)) {
      var p = u && Ei.call(e, '__wrapped__'),
        h = f && Ei.call(t, '__wrapped__')
      if (p || h) {
        var m = p ? e.value() : e,
          v = h ? t.value() : t
        return i || (i = new Jr()), o(m, v, n, r, i)
      }
    }
    return (
      !!d &&
      ...
      (function(e, t, n, r, o, i) {
        var a = n & oi,
          s = ri(e),
          c = s.length
        if (c != ri(t).length && !a) return !1
        for (var l = c; l--; ) {
          var u = s[l]
          if (!(a ? u in t : ii.call(t, u))) return !1
        }
        var f = i.get(e)
        ...
        for (var p = a; ++l < c; ) {
          var h = e[(u = s[l])],
            m = t[u]
          if (r) var v = a ? r(m, h, u, t, e, i) : r(h, m, u, e, t, i)
            ...
            (function(e, t, n, r) {
              ...
              for (; ++o < i; ) {
                ...
                if (a && s[2]) {
                  ...
                  if (!(void 0 === d ? Oi(u, l, Mi | Si, r, f) : d)) return !1
                }
              }
              return !0
            })(n, e, t)
  ...
  function Ci(e, t) {
    ...
    return (
      ...
      (Ni.test(e) || !ji.test(e) || (null != t && e in Object(t)))
    )
  }
  ...
  function Ri(e, t) {
    ...
    return (n.cache = new (Ri.Cache || Kr)()), n
  }
  Ri.Cache = Kr
  var Ai = 500
  var Fi,
    ...
    Wi = ((Fi = function(e) {
      ...
      return (
        ...
        e.replace(Ii, function(e, n, r, o) {
          t.push(r ? o.replace(zi, '$1') : n || e)
        }),
        t
      )
    }),
    (Pi = Ri(Fi, function(e) {
      return Li.size === Ai && Li.clear(), e
    })),
    (Li = Pi.cache),
    Pi)
  function Hi(e, t) {
  ...
  var Ui = 1 / 0,
    Vi = xe ? xe.prototype : void 0,
    Yi = Vi ? Vi.toString : void 0
  function Bi(e) {
    if ('string' == typeof e) return e
    if (So(e)) return Hi(e, Bi) + ''
    if (Je(e)) return Yi ? Yi.call(e) : ''
    var t = e + ''
    return '0' == t && 1 / e == -Ui ? '-0' : t
  }
  function $i(e, t) {
    return So(e)
      ? e
  ...
  function Zi(e, t) {
    return (
      null != e &&
      (function(e, t, n) {
        for (var r = -1, o = (t = $i(t, e)).length, i = !1; ++r < o; ) {
          var a = Gi(t[r])
    ...
    return Ci(e) && Di(t)
      ...
      : function(n) {
          var r = (function(e, t, n) {
            var r = null == e ? void 0 : qi(e, t)
            return void 0 === r ? n : r
          })(n, e)
          return void 0 === r && r === t ? Zi(n, e) : Oi(t, r, Ji | Qi)
        }
  }
  function ta(e) {
    return e
  ...
  function ia(e, t) {
    return (
      void 0 === t && (t = 'day'),
      { first: e[0], last: $(e[e.length - 1], 1, t) }
    )
  }
  function aa(e, t, n) {
    var r = ia(t),
      ...
      i = r.last,
      a = Ee(o, i, 'day'),
      s = ne(G(n.start(e), 'day'), o),
      c = te(ge(n.end(e), 'day'), i),
      l = (function(e, t, n) {
  ...
  function sa(e, t) {
    ...
    for (n = 0; n < e.length; n++) {
      for (o = e[n], r = 0; r < i.length && la(o, i[r]); r++);
  ...
  function ca(e, t, n, r) {
    var o = G(r.start(e), 'day'),
      i = r.end(e),
      a = ee(o, n, 'day'),
      s = K(o, i, 'minutes') ? J(i, t, 'minutes') : Z(i, t, 'minutes')
    return a && s
  }
  function la(e, t) {
  ...
  function ua(e, t, n) {
    var r = +G(n.start(e), 'day') - +G(n.start(t), 'day'),
      o = Ee(n.start(e), ge(n.end(e), 'day'), 'day'),
      i = Ee(n.start(t), ge(n.end(t), 'day'), 'day')
    return (
      r ||
  ...
  var pa,
    ha = function(e, t, n) {
      return (
        n && 'number' != typeof n && qe(e, t, n) && (t = n = void 0),
        (e = st(e)),
        void 0 === t ? ((t = e), (e = 0)) : (t = st(t)),
        (function(e, t, n, r) {
          for (
            var o = -1, i = da(fa((t - e) / (n || 1)), 0), a = Array(i);
            i--;

          )
            (a[r ? i : ++o] = e), (e += n)
          return a
        })(e, t, (n = void 0 === n ? (e < t ? 1 : -1) : st(n)), pa)
      )
    },
    ma = function(e, t) {
    ...
    ga = (function(e) {
      ...
      return (
          ...
          for (
            ...
            if (u) {
              ...
              if (this.canRenderSlotEvent(f, p)) {
                var m = Or(this.props, u)
                h && s.push(Mr(n, h, c + '_gap')),
                  s.push(Mr(n, p, c, m)),
                  (a = i = d + 1)
              } else
                h && s.push(Mr(n, h, c + '_gap')),
                  s.push(Mr(n, 1, c, this.renderShowMore(t, i))),
                  (a = i += 1)
            } else i++
          }
        ...
        (n.canRenderSlotEvent = function(e, t) {
          ...
          return ha(e, e + t).every(function(e) {
            return 1 === va(n, e)
          })
        }),
  ...
  ;(ga.propTypes = {}), (ga.defaultProps = a({}, _r))
  var ya = function(e, t) {
    return e === t
  }
  function ba(e, t) {
    ...
    return function() {
      for (var t = arguments.length, s = new Array(t), c = 0; c < t; c++)
        s[c] = arguments[c]
      return i && n === this && s.length === o.length && s.every(a)
        ? r
        : ((r = e.apply(this, s)), (i = !0), (n = this), (o = s), r)
    }
  }
  var wa = function(e, t) {
      return e.left <= t && e.right >= t
  ...
  var _a = (function(e) {
      ...
      return (
        ...
        (t.handleShowMore = function(e, r) {
          var o,
            ...
            f = ((o = n.findDOMNode(F(t))),
            (i = '.rbc-row-bg'),
            sr(o.querySelectorAll(i)))[0]
          f && (a = f.children[e - 1]),
            l(u.getEventsForSlot(e), c[e - 1], a, e, r)
        }),
        ...
        (t.renderHeadingCell = function(e, n) {
          ...
          return o({
            date: e,
            key: 'header_' + n,
            className: D('rbc-date-cell', K(e, i(), 'day') && 'rbc-now'),
          })
        }),
          ...
          return ba(function(t) {
            ...
            return {
              ...
              continuesPrior: function(e) {
                return Q(s.start(e), l, 'day')
              },
              continuesAfter: function(e) {
                var t = s.end(e)
                return K(s.start(e), t, 'minutes')
                  ? J(t, u, 'minutes')
                  : Z(t, u, 'minutes')
              },
            }
    ...
    return (
      (o.getRowLimit = function() {
        var e = ir(this.eventRow),
          t = this.headingRow ? ir(this.headingRow) : 0,
          r = ir(n.findDOMNode(this)) - t
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              a({ isAllDay: _ }, x),
              M.map(function(e, t) {
                return r.createElement(Sr, a({ key: t, segments: e }, x))
              }),
              !!S.length &&
                r.createElement(
                  ga,
                  a({ segments: S, onShowMore: this.handleShowMore }, x)
                )
            )
          )
        )
  ...
  ;(_a.propTypes = {}), (_a.defaultProps = { minRows: 0, maxRows: 1 / 0 })
  var Oa = function(e) {
    var t = e.label
  ...
  var Ma = function(e) {
    var t = e.label,
      ...
      o = e.onDrillDown
    return n
      ? r.createElement('a', { href: '#', onClick: o }, t)
  ...
  var Sa = function(e, t, n, r) {
    ...
    Da = (function(e) {
      function t() {
        for (var t, o = arguments.length, i = new Array(o), c = 0; c < o; c++)
          i[c] = arguments[c]
        return (
          ((t =
            e.call.apply(e, [this].concat(i)) ||
            this).getContainer = function() {
            return n.findDOMNode(F(t))
          }),
          (t.renderWeek = function(e, n) {
            var o = t.props,
              ...
              g = m.rowLimit
            return (
              (i = Sa(i, e[0], e[e.length - 1], p)).sort(function(e, t) {
                return ua(e, t, p)
              }),
              r.createElement(_a, {
                key: n,
          ...
          (t.readerDateHeading = function(e) {
            var n = e.date,
              ...
              v = t.props.components.dateHeader || Ma
            return r.createElement(
              'div',
              a({}, i, {
                className: D(o, d && 'rbc-off-range', p && 'rbc-current'),
              }),
              r.createElement(v, {
                label: m,
                date: n,
          ...
          (t.handleHeadingClick = function(e, n, r) {
            r.preventDefault(),
              t.clearSelection(),
              N(t.props.onDrillDown, [e, n])
          }),
          (t.handleSelectEvent = function() {
            t.clearSelection()
            for (var e = arguments.length, n = new Array(e), r = 0; r < e; r++)
              n[r] = arguments[r]
            N(t.props.onSelectEvent, n)
          }),
          (t.handleDoubleClickEvent = function() {
            t.clearSelection()
            for (var e = arguments.length, n = new Array(e), r = 0; r < e; r++)
              n[r] = arguments[r]
            N(t.props.onDoubleClickEvent, n)
          }),
          (t.handleShowMore = function(e, r, o, i, a) {
            var s = t.props,
              c = s.popup,
              l = s.onDrillDown,
              u = s.onShowMore,
            ...
            if ((t.clearSelection(), c)) {
              var d = xt(o, n.findDOMNode(F(t)))
              t.setState({
                overlay: { date: r, events: e, position: d, target: a },
              })
            } else N(l, [r, f(r) || T.DAY])
            N(u, [e, r, i])
          }),
          (t._bgRows = []),
          (t._pendingSelection = []),
      ...
      return (
        (o.UNSAFE_componentWillReceiveProps = function(e) {
          var t = e.date
          this.setState({ needLimitMeasure: !K(t, this.props.date, 'month') })
        }),
        (o.componentDidMount = function() {
          var e,
            t = this
        ...
        (o.render = function() {
          var e = this.props,
            ...
            o = e.className,
            i = (function(e, t, n) {
              t = (n ? qe(e, t, n) : void 0 === t) ? 1 : ut(ct(t), 0)
              var r = null == e ? 0 : e.length
              if (!r || t < 1) return []
              for (var o = 0, i = 0, a = Array(lt(r / t)); o < r; )
                a[i++] = _e(e, o, (o += t))
              return a
            })(
              (function(e, t) {
                for (var n = me(e, t), r = ve(e, t), o = []; ee(n, r, 'day'); )
                  o.push(n), (n = $(n, 1, 'day'))
                return o
              })(t, n),
              7
        ...
        (o.renderHeaders = function(e) {
          var t = this.props,
            ...
            a = e[e.length - 1],
            s = o.header || Oa
          return ye(i, a, 'day').map(function(e, t) {
            return r.createElement(
              'div',
  ...
  ;(Da.propTypes = {}),
    (Da.range = function(e, t) {
      var n = t.localizer
      return { start: me(e, n), end: ve(e, n) }
    }),
    (Da.navigate = function(e, t) {
      switch (t) {
        case x.PREVIOUS:
          return $(e, -1, 'month')
        case x.NEXT:
  ...
  var xa = function(e, t) {
    ...
    Ta = function(e, t, n, r) {
      return +G(e, 'minutes') + '' + +G(t, 'minutes') + n + '-' + r
    }
  function ja(e) {
    for (
      var t = e.min,
    ...
    return (
      ...
      ),
      {
        groups: d,
        update: function(e) {
          return Ta(e) !== i ? ja(e) : this
        },
        dateIsInGroup: function(e, t) {
          var r = d[t + 1]
          return re(e, d[t][0], r ? r[0] : n, 'minutes')
        },
        nextSlot: function(e) {
          var t = p[Math.min(p.indexOf(e) + 1, p.length - 1)]
          return t === e && (t = $(e, r, 'minutes')), t
        },
        ...
        closestSlotFromDate: function(e, n) {
          if ((void 0 === n && (n = 0), Q(e, t, 'minutes'))) return p[0]
          var o = Ee(t, e, 'minutes')
          return p[(o - (o % r)) / r + n]
        },
        ...
        startsBefore: function(e) {
          return Q(be(t, e), t, 'minutes')
        },
        startsAfter: function(e) {
          return Z(be(n, e), n, 'minutes')
        },
        getRange: function(e, o, i, a) {
          i || (e = te(n, ne(t, e))), a || (o = te(n, ne(t, o)))
          var s = b(e),
            c = b(o),
            l =
              c - s < r && !K(n, o)
  ...
  var Ca = xe ? xe.isConcatSpreadable : void 0
  function ka(e) {
    return So(e) || Po(e) || !!(Ca && e && e[Ca])
  }
  ...
  function Wa(e, t, n) {
    return (
      (t = za(void 0 === t ? e.length - 1 : t, 0)),
      function() {
        for (
          var r = arguments, o = -1, i = za(r.length - t, 0), a = Array(i);
          ++o < i;
  ...
  var $a = (function(e) {
    ...
    return function() {
      var r = Ba(),
        o = Ya - (r - n)
      if (((n = r), o > 0)) {
        if (++t >= Va) return arguments[0]
      } else t = 0
      return e.apply(void 0, arguments)
    }
  })(Ua)
  function Xa(e, t) {
    return $a(Wa(e, t, ta), e + '')
  }
    ...
    for (
      var t = e.events,
        ...
        i = (function(e) {
          ...
          t.map(function(e) {
            return new qa(e, { slotMetrics: r, accessors: o })
          })
        ),
        a = [],
        s = function(e) {
    ...
    'no-overlap': function(e) {
      ...
      for (var f = 0; f < t.length; ++f) {
        ...
        for (var m = 0; m < d.friends.length; ++m)
          void 0 !== d.friends[m].idx && (p[d.friends[m].idx] = 0)
        d.idx = p.indexOf(1)
      }
      ...
      for (var w = 0; w < t.length; ++w) {
        ...
        for (var _ = 0, O = 0; O < E.friends.length; ++O) {
          var M = E.friends[O]
          _ = _ > M ? _ : M
        }
    ...
    return (
      ...
      (t.prototype.render = function() {
        ...
        return r.createElement(
          ...
          o.map(function(e, o) {
            var i = s ? s.slotProp(e, n) : {}
            return r.createElement(
              u,
              { key: o, value: e, resource: n },
              r.createElement(
                'div',
                a({}, i, { className: D('rbc-time-slot', i.className) }),
                t && t(e, o)
              )
            )
          })
  ...
  function ns(e) {
    var t,
      ...
      E = s.end(i),
      _ = s.start(i),
      O = p.eventProp(i, _, E, l),
      M = n.height,
      S = n.top,
      x = n.width,
      T = n.xOffset,
      j = [
        r.createElement('div', { key: '1', className: 'rbc-event-label' }, u),
        r.createElement(
          'div',
          { key: '2', className: 'rbc-event-content' },
          g ? r.createElement(g, { event: i, title: b }) : b
        ),
      ]
    return r.createElement(
      y,
      ...
      r.createElement(
        'div',
        {
          ...
          className: D('rbc-event', o, O.className, {
            'rbc-selected': l,
      ...
      return (
        ...
        (t.renderEvents = function() {
          ...
          return (function(e) {
            ...
            var u,
              ...
              m = a.end(f),
              v = a.start(f),
              g = 'eventTimeRangeFormat',
              y = p.startsBeforeDay(v),
              b = p.startsAfterDay(m)
            y
              ? (g = 'eventTimeRangeEndFormat')
              : b && (g = 'eventTimeRangeStartFormat'),
              (u = y && b ? h.allDay : s.format({ start: v, end: m }, g))
            var w = y || p.startsBefore(v),
              E = b || p.startsAfter(m)
        ...
        (t._selectable = function() {
          var e = n.findDOMNode(F(t)),
            ...
            o = function(e) {
              var n = t.props.onSelecting,
                ...
                s = o.endDate
              ;(n &&
                ((K(r.startDate, a, 'minutes') && K(r.endDate, s, 'minutes')) ||
                  !1 ===
                    n({ start: a, end: s, resourceId: t.props.resource }))) ||
            ...
            i = function(n) {
              ...
              ee(o, r)
                ...
                : Z(o, r) && (o = t.slotMetrics.nextSlot(o))
              var i = t.slotMetrics.getRange(te(o, r), ne(o, r))
              return a({}, i, {
                selecting: !0,
                top: i.top + '%',
                height: i.height + '%',
            ...
            s = function(e, r) {
              if (!mr(n.findDOMNode(F(t)), e)) {
                var o = i(e),
                  a = o.startDate,
                  s = o.endDate
                t._selectSlot({ startDate: a, endDate: s, action: r, box: e })
              }
          ...
          r.on('selecting', o),
            ...
            r.on('select', function(e) {
              t.state.selecting &&
                (t._selectSlot(a({}, t.state, { action: 'select', bounds: e })),
                t.setState({ selecting: !1 }))
            }),
            r.on('reset', function() {
        ...
        (t._selectSlot = function(e) {
          for (
            ...
            c.push(s), (s = $(s, t.props.step, 'minutes'))
          N(t.props.onSelectSlot, {
            slots: c,
            start: n,
            end: r,
    ...
    return (
      ...
      (o.render = function() {
        var e = this.props,
          ...
          h = s(d, ['eventContainerWrapper']),
          m = this.slotMetrics,
          v = this.state,
          g = v.selecting,
          y = v.top,
          b = v.height,
          w = { start: v.startDate, end: v.endDate },
          E = u(t),
          _ = E.className,
          O = E.style
        return r.createElement(
          ...
          g &&
            r.createElement(
              'div',
              { className: 'rbc-slot-selection', style: { top: y, height: b } },
              r.createElement('span', null, c.format(w, 'selectRangeFormat'))
            ),
          o &&
            r.createElement('div', {
    ...
    is = (function(e) {
      function t() {
        ...
        ;(t = e.call.apply(e, [this].concat(o)) || this).renderSlot = function(
          ...
          return r.createElement(
            'span',
            { className: D('rbc-label', s && 'rbc-now') },
        ...
        var a = t.props,
          ...
          u = a.step
        return (
          (t.slotMetrics = ja({ min: s, max: c, timeslots: l, step: u })), t
        )
      }
      c(t, e)
      var n = t.prototype
  ...
  function as(e, t) {
    var n = wt(e)
    return n ? n.innerWidth : t ? e.clientWidth : Mt(e).width
  }
  function ss(e) {
    if (((!os && 0 !== os) || e) && Tt) {
      ...
      ;(t.style.position = 'absolute'),
        ...
        (os = t.offsetWidth - t.clientWidth),
    ...
    function t() {
      ...
      return (
        ((t =
          ...
          r.preventDefault(), N(t.props.onDrillDown, [e, n])
        }),
    ...
    return (
        ...
        return e.map(function(e, n) {
          ...
          return r.createElement(
            'div',
            {
              key: n,
              style: p,
              className: D('rbc-header', d, K(e, u, 'day') && 'rbc-today'),
            },
            a
              ? r.createElement(
                  'a',
      ...
      (n.render = function() {
        var e = this,
          ...
          b = void 0 === y ? cs : y,
          w = {}
        m && (w[o ? 'marginLeft' : 'marginRight'] = ss() + 'px')
        var E = i.groupEvents(s)
        return r.createElement(
          'div',
          {
            style: w,
    ...
    function t(t) {
      ...
      return (
        ...
        (o.handleResize = function() {
          Rt(o.rafHandle), (o.rafHandle = At(o.checkOverflow))
        }),
        ...
        (o.handleSelectAlldayEvent = function() {
          ...
          for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
            t[n] = arguments[n]
          N(o.props.onSelectEvent, t)
        }),
        (o.handleSelectAllDaySlot = function(e, t) {
          N(o.props.onSelectSlot, {
            slots: e,
            start: e[0],
            end: e[e.length - 1],
            action: t.action,
        ...
        (o.memoizedResources = ba(function(e, t) {
          return (function(e, t) {
            return {
              map: function(n) {
                return e
    ...
    return (
      ...
      (o.UNSAFE_componentWillReceiveProps = function(e) {
        var t = this.props,
          n = t.range,
          r = t.scrollToTime
        ;(K(e.range[0], n[0], 'minute') && K(e.scrollToTime, r, 'minute')) ||
          this.calculateScroll(e)
      }),
      (o.renderEvents = function(e, t, n) {
        var o = this,
          i = this.props,
          s = i.min,
          c = i.max,
        ...
        return p.map(function(t, i) {
          ...
          return e.map(function(e, t) {
            var v = (h.get(p) || []).filter(function(t) {
              return re(e, u.start(t), u.end(t), 'day')
            })
            return r.createElement(
              rs,
              a({}, o.props, {
        ...
        return (
          t.forEach(function(e) {
            if (ca(e, g, y, u)) {
              var t = u.start(e),
                n = u.end(e)
              u.allDay(e) || (we(t) && we(n)) || (!m && !K(t, n, 'day'))
                ? b.push(e)
                : w.push(e)
            }
          }),
          ...
          r.createElement(
            'div',
            { className: D('rbc-time-view', c && 'rbc-time-view-resources') },
            r.createElement(ls, {
              range: n,
              events: b,
              width: o,
              ...
              localizer: d,
              selected: a,
              resources: this.memoizedResources(c, u),
    ...
    return (
      ...
      (t.prototype.render = function() {
        var e = this.props,
          ...
          o = s(e, ['date']),
          i = t.range(n)
        return r.createElement(fs, a({}, o, { range: i, eventOffset: 10 }))
      }),
      t
    )
  })(r.Component)
  ...
  var ps = (function(e) {
    ...
    return (
      ...
      (t.prototype.render = function() {
        ...
        return r.createElement(fs, a({}, o, { range: i, eventOffset: 15 }))
      }),
      t
    )
  })(r.Component)
  function hs(e, t) {
    return ps.range(e, t).filter(function(e) {
      return -1 === [6, 0].indexOf(e.getDay())
    })
  }
  ;(ps.propTypes = {}),
    (ps.defaultProps = fs.defaultProps),
    (ps.navigate = function(e, t) {
      switch (t) {
        case x.PREVIOUS:
          return $(e, -1, 'week')
        case x.NEXT:
    ...
    (ps.range = function(e, t) {
      ...
      return ye(G(e, 'week', n), q(e, 'week', n))
    }),
    (ps.title = function(e, t) {
      var n = t.localizer,
        r = ps.range(e, { localizer: n }),
        o = r[0],
        i = r.slice(1)
    ...
    return (
      ...
      (t.prototype.render = function() {
        var e = this.props,
          ...
          n = s(e, ['date']),
          o = hs(t, this.props)
        return r.createElement(fs, a({}, n, { range: o, eventOffset: 15 }))
      }),
      t
    )
  })(r.Component)
  ...
  ;(ms.propTypes = {}),
    (ms.defaultProps = fs.defaultProps),
    (ms.range = hs),
    (ms.navigate = ps.navigate),
  ...
  var gs,
    ys = (function(e) {
      function t(t) {
        var n
        return (
          ((n = e.call(this, t) || this).renderDay = function(e, t, o) {
            var i = n.props,
              a = i.selected,
              s = i.getters,
              c = i.accessors,
            ...
            return (t = t.filter(function(t) {
              return ca(t, G(e, 'day'), q(e, 'day'), c)
            })).map(function(i, u) {
              var p = c.title(i),
                h = c.end(i),
                m = c.start(i),
                v = s.eventProp(i, m, h, Pt(i, a)),
                g = 0 === u && l.format(e, 'agendaDateFormat'),
                y =
                  0 === u &&
                  r.createElement(
                    'td',
                    { rowSpan: t.length, className: 'rbc-agenda-date-cell' },
                    d ? r.createElement(d, { day: e, label: g }) : g
                  )
              return r.createElement(
                'tr',
                { key: o + '_' + u, className: v.className, style: v.style },
                y,
                r.createElement(
                  'td',
                  { className: 'rbc-agenda-time-cell' },
                  n.timeRangeLabel(e, i)
                ),
                r.createElement(
                  'td',
                  { className: 'rbc-agenda-event-cell' },
                  f ? r.createElement(f, { event: i, title: p }) : p
                )
              )
            }, [])
          }),
            ...
            return (
              i.allDay(t) ||
                (K(f, u)
                  ...
                  : K(e, f, 'day')
                  ? (l = a.format(f, 'agendaTimeFormat'))
                  : K(e, u, 'day') && (l = a.format(u, 'agendaTimeFormat'))),
              Z(e, f, 'day') && (s = 'rbc-continues-prior'),
              Q(e, u, 'day') && (s += ' rbc-continues-after'),
              r.createElement(
                'span',
                { className: s.trim() },
                c ? r.createElement(c, { event: t, day: e, label: l }) : l
              )
            )
          }),
            ...
            if (n.tbodyRef.current) {
              ...
              if (t) {
                var r,
                  ...
                  a = n._widths || []
                ;(n._widths = [as(t.children[0]), as(t.children[1])]),
                  (a[0] === n._widths[0] && a[1] === n._widths[1]) ||
                    ((n.dateColRef.current.style.width = n._widths[0] + 'px'),
                    (n.timeColRef.current.style.width = n._widths[1] + 'px')),
                  i
                    ? ((o = 'rbc-header-overflowing'),
                      ...
                      (e.style.marginRight = ss() + 'px'))
                    : (function(e, t) {
                        e.classList
                          ? e.classList.remove(t)
                          : 'string' == typeof e.className
                          ? (e.className = vs(e.className, t))
                          : e.setAttribute(
                              'class',
                              vs((e.className && e.className.baseVal) || '', t)
                            )
                      })(e, 'rbc-header-overflowing')
              }
            }
          }),
          (n.headerRef = r.createRef()),
          (n.dateColRef = r.createRef()),
          (n.timeColRef = r.createRef()),
          (n.contentRef = r.createRef()),
          (n.tbodyRef = r.createRef()),
          n
        )
      }
      c(t, e)
                    ...
                    r.createElement(
                      ...
                      r.createElement(
                        ...
                        r.createElement(
                          ...
                          r.createElement(
                            'th',
                            { className: 'rbc-header', ref: this.dateColRef },
                            s.date
                          ),
                          r.createElement(
                            'th',
                            { className: 'rbc-header', ref: this.timeColRef },
                            s.time
                          ),
                          r.createElement(
                            'th',
  ...
  ;(ys.propTypes = {}),
    ...
    (ys.range = function(e, t) {
      ...
      return {
        start: e,
        end: $(e, void 0 === n ? ys.defaultProps.length : n, 'day'),
      }
    }),
    (ys.navigate = function(e, t, n) {
      var r = n.length,
        o = void 0 === r ? ys.defaultProps.length : r
      switch (t) {
        case x.PREVIOUS:
          return $(e, -o, 'day')
        case x.NEXT:
    ...
    (ys.title = function(e, t) {
      var n = t.length,
        r = void 0 === n ? ys.defaultProps.length : n,
        o = t.localizer,
        i = $(e, r, 'day')
      return o.format({ start: e, end: i }, 'agendaHeaderFormat')
    })
  var bs = (((gs = {})[T.MONTH] = Da),
  (gs[T.WEEK] = ps),
  (gs[T.WORK_WEEK] = ms),
  (gs[T.DAY] = ds),
  (gs[T.AGENDA] = ys),
  ...
  function ws(e, t) {
    var n = t.action,
      r = t.date,
      o = t.today,
      i = s(t, ['action', 'date', 'today'])
    switch (((e = 'string' == typeof e ? bs[e] : e), n)) {
      case x.TODAY:
        r = o || new Date()
        break
      case x.DATE:
      ...
      (n.render = function() {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              'button',
              { type: 'button', onClick: this.navigate.bind(null, x.TODAY) },
              t.today
            ),
            r.createElement(
              'button',
              { type: 'button', onClick: this.navigate.bind(null, x.PREVIOUS) },
              t.previous
            ),
            r.createElement(
              'button',
              { type: 'button', onClick: this.navigate.bind(null, x.NEXT) },
              t.next
            )
          ),
  ...
  function Os(e, t, n) {
    '__proto__' == t && Ha
      ? Ha(e, t, { configurable: !0, enumerable: !0, value: n, writable: !0 })
      : (e[t] = n)
  }
  Es.propTypes = {}
  ...
  function Ss(e, t, n) {
    var r = e[t]
    ;(Ms.call(e, t) && Oe(r, n) && (void 0 !== n || t in e)) || Os(e, t, n)
  }
  function Ds(e, t, n, r) {
    var o = !n
    n || (n = {})
    for (var i = -1, a = t.length; ++i < a; ) {
      ...
      void 0 === c && (c = e[s]), o ? Os(n, s, c) : Ss(n, s, c)
    }
    return n
  }
  ...
  function js(e) {
    return Be(e) ? Ko(e, !0) : Ts(e)
  }
  var Ns = 'object' == typeof e && e && !e.nodeType && e,
    Cs =
      Ns && 'object' == typeof module && module && !module.nodeType && module,
    ks = Cs && Cs.exports === Ns ? De.Buffer : void 0,
    Rs = ks ? ks.allocUnsafe : void 0
  var As = Qo(Object.getPrototypeOf, Object),
    Fs = Object.getOwnPropertySymbols
      ? function(e) {
          for (var t = []; e; ) Mo(t, No(e)), (e = As(e))
          return t
        }
      : xo
  function Ps(e) {
  ...
  function sc(e, t, n) {
    ...
    switch (t) {
      ...
      case $s:
        return (
          ((i = new (o = e).constructor(o.source, zs.exec(o))).lastIndex =
            o.lastIndex),
          i
        )
      case Xs:
        return new a()
      case qs:
        return (r = e), Hs ? Object(Hs.call(r)) : {}
    }
  }
    ...
    if (dc(e))
      return (
        e.forEach(function(r, o) {
          a.set(o, Mc(r, t, n, o, e, i))
        }),
        a
      )
    var h = l ? (c ? Ps : ri) : c ? keysIn : ni,
      m = u ? void 0 : h(e)
    return (
      _s(m || e, function(r, o) {
        m && (r = e[(o = r)]), Ss(a, o, Mc(r, t, n, o, e, i))
      }),
      a
    )
  }
  function Sc(e, t) {
    return (
      null ==
        (e = (function(e, t) {
          return t.length < 2 ? e : qi(e, _e(t, 0, -1))
        })(e, (t = $i(t, e)))) ||
      delete e[
  ...
  ;(Oc[bc] = Oc['[object Array]'] = Oc['[object ArrayBuffer]'] = Oc[
    '[object DataView]'
  ] = Oc['[object Boolean]'] = Oc['[object Date]'] = Oc[
    '[object Float32Array]'
  ] = Oc['[object Float64Array]'] = Oc['[object Int8Array]'] = Oc[
    '[object Int16Array]'
  ] = Oc['[object Int32Array]'] = Oc['[object Map]'] = Oc[
    '[object Number]'
  ] = Oc[_c] = Oc['[object RegExp]'] = Oc['[object Set]'] = Oc[
    '[object String]'
  ] = Oc['[object Symbol]'] = Oc['[object Uint8Array]'] = Oc[
    '[object Uint8ClampedArray]'
  ] = Oc['[object Uint16Array]'] = Oc['[object Uint32Array]'] = !0),
    (Oc['[object Error]'] = Oc[wc] = Oc['[object WeakMap]'] = !1)
  ...
  function kc(e) {
    return (function(e) {
      if (!Ke(e) || Pe(e) != Dc) return !1
      var t = As(e)
      if (null === t) return !0
      var n = Nc.call(t, 'constructor') && t.constructor
      return 'function' == typeof n && n instanceof n && jc.call(n) == Cc
    })(e)
      ? void 0
      : e
  }
  function Rc(e) {
    return (null == e ? 0 : e.length) ? Ra(e, 1) : []
  }
  var Ac = (function(e) {
      return $a(Wa(e, void 0, Rc), e + '')
    })(function(e, t) {
      var n = {}
      if (null == e) return n
      var r = !1
    ...
    Lc = Xa(function(e, t) {
      ...
      for (o && qe(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var i = t[n], a = js(i), s = -1, c = a.length; ++s < c; ) {
          var l = a[s],
            u = e[l]
          ;(void 0 === u || (Oe(u, Fc[l]) && !Pc.call(e, l))) && (e[l] = i[l])
        }
      return e
    })
  var Ic = function(e) {
      ...
      return (
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = ra(t)), null == n)) {
                  ...
                  n = o ? (r ? new i() : []) : Le(e) && Ue(i) ? lc(As(e)) : {}
                }
                return (
                  (o ? _s : Fa)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
        ...
        (t.handleNavigate = function(e, n) {
          var r = t.props,
            ...
            c = r.getNow,
            l = r.onNavigate,
            u = s(r, ['view', 'date', 'getNow', 'onNavigate']),
            f = t.getView(),
            d = c()
          l(
            (i = ws(f, a({}, u, { action: e, date: n || i || d, today: d }))),
            o,
            e
          ),
            t.handleRangeChange(i, f)
        }),
        (t.handleViewChange = function(e) {
          e !== t.props.view &&
            (function(e, t) {
              return -1 !== zc(t.views).indexOf(e)
            })(e, t.props) &&
            t.props.onView(e)
          var n = t.getViews()
    ...
    return (
      ...
      (n.getContext = function(e) {
        ...
        return {
          ...
          components: Lc(E[h] || {}, Ac(E, M), {
            eventWrapper: i,
            eventContainerWrapper: i,
            dateCellWrapper: i,
            weekWrapper: i,
            timeSlotWrapper: i,
          }),
      ...
      (n.render = function() {
        ...
        var v = this.getView(),
          ...
          _ = g.viewNames,
          O = b.toolbar || Es,
          M = v.title(u, { localizer: E, length: d })
        return r.createElement(
          'div',
          a({}, l, {
            className: D(c, 'rbc-calendar', m.rtl && 'rbc-rtl'),
            style: i,
          }),
          n &&
            r.createElement(O, {
  ...
  ;(Wc.defaultProps = {
    ...
    toolbar: !0,
    view: T.MONTH,
    views: [T.MONTH, T.WEEK, T.DAY, T.AGENDA],
    step: 30,
    length: 30,
    drilldownView: T.DAY,
    titleAccessor: 'title',
  ...
  var Hc = (function e(t, n, o) {
          ...
          (u.render = function() {
            ...
            return (
              c.forEach(function(t) {
                var n = e.props[t]
                a[t] = void 0 !== n ? n : e._values[t]
              }),
              r.createElement(
                t,
                w({}, i, a, this.handlers, { ref: o || this.attachRef })
              )
            )
          }),
          s
      ...
      return (
        r.forwardRef &&
          ((f = r.forwardRef(function(e, t) {
            return r.createElement(u, w({}, e, { innerRef: t }))
          })).propTypes = u.propTypes),
        (f.ControlledComponent = t),
        (f.deferControlTo = function(t, r, o) {
          return void 0 === r && (r = {}), e(t, w({}, n, r), o)
        }),
        f
      )
    })(Wc, { view: 'onView', date: 'onNavigate', selected: 'onSelectEvent' }),
    Uc = function(e, t, n) {
      var r = e.start,
        o = e.end
    ...
    Vc = {
      ...
      dayFormat: 'DD ddd',
      weekdayFormat: 'ddd',
      selectRangeFormat: Uc,
      eventTimeRangeFormat: Uc,
      ...
      dayRangeHeaderFormat: function(e, t, n) {
        ...
        return (
          ...
          ' – ' +
          n.format(o, K(r, o, 'month') ? 'DD' : 'MMMM DD', t)
        )
      },
  ...
  var Yc = function(e, t, n) {
    ...
    Bc = {
      ...
      dayFormat: 'ddd dd/MM',
      weekdayFormat: 'ddd',
      selectRangeFormat: Yc,
      eventTimeRangeFormat: Yc,
      eventTimeRangeStartFormat: function(e, t, n) {
        var r = e.start
      ...
      dayRangeHeaderFormat: function(e, t, n) {
        ...
        return (
          n.format(r, 'MMM dd', t) +
          ' – ' +
          n.format(o, K(r, o, 'month') ? 'dd' : 'MMM dd', t)
        )
      },
      agendaHeaderFormat: function(e, t, n) {
        var r = e.start,
  ...
  var Xc = function(e, t, n) {
    ...
    Gc = {
      ...
      dayFormat: 'eee dd/MM',
      weekdayFormat: 'eee',
      selectRangeFormat: Xc,
      eventTimeRangeFormat: Xc,
      eventTimeRangeStartFormat: function(e, t, n) {
        var r = e.start
  ...
  var qc = function(e, t, n) {
    ...
    Kc = {
      ...
      dayFormat: 'dd ddd',
      weekdayFormat: 'cccc',
      selectRangeFormat: qc,
      eventTimeRangeFormat: qc,
      eventTimeRangeStartFormat: function(e, t, n) {
        var r = e.start
      ...
      agendaDateFormat: 'ddd MMM dd',
      agendaTimeFormat: 'p',
      agendaTimeRangeFormat: qc,
    },
    Zc = { eventWrapper: i, timeSlotWrapper: i, dateCellWrapper: i }
  ;(e.Calendar = Hc),
    (e.DateLocalizer = k),
    (e.Navigate = x),
    (e.Views = T),
        ...
        ? new k({
            firstOfWeek: function(e) {
              try {
                ...
                var i = new Date(),
                  a = Math.max(
                    parseInt(t(e).formatDate(i, { raw: 'e' }), 10) - 1,
                    0
                  )
                return Math.abs(i.getDay() - a)
              }
            },
            formats: Gc,
